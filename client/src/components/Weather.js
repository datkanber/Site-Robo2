  ...
  return (
    <section id="weather" className="py-20" style={{ backgroundImage: 'linear-gradient(120deg, #0084f0a1, #d9e2ec, #548cc4)' }}>
      <div className="container mx-auto text-center pb-10">
        <h2 className="my-weather">Current Weather</h2>
        <div className="mb-4">
          ...
          <select
            id="city"
            className="p-2 rounded border border-gray-400 text-blue-900"
            value={city}
        ...
        <div className="weather-container">
          <h3 className="text-2xl font-bold mb-4 text-black">{city}</h3>
          <div className="weather-icon">
            {getWeatherIcon(description)}
          </div>
          <p className="text-xl mb-2 text-black">Temperature: {temperature}°C</p>
          <p className="text-lg mb-4 text-black">Condition: {description}</p>
          <p className="text-md font-semibold text-black">{advice}</p>
          {image && <img src={image} alt={city} className="weather-image" />}
