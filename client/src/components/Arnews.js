...
const Arnews = () => {
  ...
  return (
    <section id="Arnews" className="py-20" style={{ backgroundImage: 'linear-gradient(120deg, #0084f0a1, #d9e2ec, #548cc4)' }}>
      <div className="container mx-auto text-center pb-10">
      <h2 className="my-ar">Latest AI News</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {articles.map((article, index) => (
            <div key={index} className="bg-white p-20 rounded text-black shadow-md">
              {article.imageUrl && (
